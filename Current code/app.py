...
#Task: Detects if a request coming from JavaScript or a normal page
...
#Task: Applies all the players' names
#Precondition: All the players' objects and names have been created
#Postcondition: All the players' names are established
def apply_player_names():
    ...
    deck.player1.name = username
    deck.player2.name = BOT_NAMES[0]
    deck.player3.name = BOT_NAMES[1]
    deck.player4.name = BOT_NAMES[2]
    ...
    if deck.round:
        deck.round.players = deck.players
...
def build_game_context():
    ...
    return {
        ...
        "player_names": {
            "player1": deck.player1.name,
            "player2": deck.player2.name,
            "player3": deck.player3.name,
            "player4": deck.player4.name,
        },
    }
...
#Task: API call to render the page for the user to input a name
#Precondition: A new game must be started
#Postcondition: The user has selected their name
@app.route("/username")
def username_screen():
    return render_template("username.html")

#Task: API call so the user can choose their name
#Precondition: The user must input their name
#Postcondition: The user's name has been chosen
...
#Precondition: The user has selected their name
